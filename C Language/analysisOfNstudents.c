//changes to array in function reflects 
//we can use array argument as pointer or simple array both 
//in main function just write array name and in function bracket also
#include <stdio.h>
